...
lineages_root = workspace_root / "lineages"
...
class LineageManager:
    ...
    def exists(self, lineage_id: str) -> bool:
        return (lineages_root / lineage_id).exists()
