...
def exec_tool(tool_name: str, args: dict, modules: dict, definitions: dict, vault_path: str, lineage_root: str):
    ...
    handlers = {
        ...
        "broadcast_event": lambda: fn(args.get("type", "INFO"), args.get("message", ""), lineage_root),
        "pray": lambda: fn(args.get("content", ""), lineage_root),
        "delegate_task": lambda: fn(args.get("target_lineage_id", ""), args.get("message", ""), lineage_root),
